...
class inode_state {
   ...
   public:
      ...
      string getCurrDirectory() { return currDirectory; }
      void setCurrDirectory(string newDir) { currDirectory = newDir; };
      void set_cwd(inode_ptr newCwd) { cwd = newCwd; };
      void set_prompt(const string& newPrompt) { prompt_ = newPrompt; };
};
...
class inode {
   ...
   public:
      ...
      base_file_ptr getCon() { return contents; }
};
...
class base_file {
   ...
   public:
      ...
      virtual void setFile(bool newFile) { FileBool = newFile; }
      virtual bool File_Bool() { return FileBool; }
      virtual map<string, inode_ptr> getDirents();
      virtual void addBranch(const string& filename, inode_ptr pointer);
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void addBranch(const string& filename, inode_ptr ptr) override;
};
